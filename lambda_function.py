    ...
    if age is not None:
        ...
        if age <0 or age >65:
            return build_validation_result(
                False,
                "age",
                "The age needs to be 65 or under. Could you input another age?",
            )
    ...
    if dollars is not None:
        ...
        if dollars < 5000:
            return build_validation_result(
                ...
                "please provide another amount in that range.",
            )
...
def get_recommendation(riskLevel):
    ...
    if riskLevel == "none" :
        ...
        recommendation = "Please hoose between none, low, medium, high."
